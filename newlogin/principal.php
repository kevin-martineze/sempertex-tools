...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">Sempertex</a>
        <!-- Sidebar Toggle-->
...
<form>
                        ...
                        <div class="i">
                                    <select class="form-select form-select-lg mb-3 input-group mb-3" aria-label=".form-select-lg example">
                                        <option selected>Tipo de documento</option>
                                        <option value="1">C.C</option>
                                        <option value="2">T.I</option>
                                        <option value="2">DNI</option>
                                        <option value="2">Tarjeta pasaporte</option>
